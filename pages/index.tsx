...
const Home: NextPage = () => {
  return (
    <Layout title='Webjeb Studios | Jamstack Websites For All'>
      ...
      <Section id='benefits' customStyles={BenefitsStyles}>
        <BenefitsContainer>
          <div className='blurb'>
            <h3>Speed</h3>
            <p>
          ...
          <div className='blurb'>
            <h3>Security</h3>
            <p>
              Your site is statically rendered instead of generated by a server.
              This eliminates server requests so you're less vulnerable to
              attacks.
            </p>
          </div>
          <div className='blurb span2'>
            <h3>Scale</h3>
            <p>
              Scale with ease without the hefty price tag. With CDNs, your site
              scales automatically as your audience grows.
            </p>
          </div>
        </BenefitsContainer>
      </Section>
      <Section id='discover'>
        <DiscoverContainer>
          <div className='part1'>
            <h2>Is your site built on old architecture?</h2>
            <p className='emphasis'>
              In today's crowded and constantly changing web, your site needs to
              be flexible and nimble to stand out from the pack.
            </p>
            <p className='body'>
