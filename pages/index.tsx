          ...
          <BenefitsContainer>
            ...
            <div className='blurb'>
              ...
              <p>
                ...
                served by content delivery networks (CDNs) all over the world.
              </p>
            </div>
            <div className='blurb'>
              <h3>Secure</h3>
              <p>
                ...
                server. This eliminates server requests so you're less
            ...
            <div className='blurb'>
              ...
              <p>
                Scale with ease without the hefty price tag. With CDNs, your
                site scales automatically as your audience grows.
              </p>
            </div>
          </BenefitsContainer>
        </HeroContainer>
